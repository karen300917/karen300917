...
const portfolioData = {
  ...
  focus: "Datos & seguridad",
  email: "jckarenmelissa@gmail.com",
  phone: "315 635 7567",
  whatsappNumber: "573156357567",
  whatsappMessage: "Hola Karen, vi tu portafolio y me gustaría conversar contigo.",
  links: {
    github: "https://github.com/karen300917",
    linkedin: "https://www.linkedin.com/"
  },
  stats: { projects: 5, technologies: 12 },
  projects: [
    { name: "Sistema de Inventario", description: "Control de productos, entradas y reportes.", category: "Desarrollo", technologies: ["JavaScript", "SQL"], status: "Completado", link: "#" },
  ...
  skills: [
    ...
    { name: "Bases de datos", level: 82, icon: "bi-database" },
    { name: "Desarrollo web", level: 76, icon: "bi-code-square" },
    { name: "Ciberseguridad", level: 72, icon: "bi-shield-check" }
  ]
};
